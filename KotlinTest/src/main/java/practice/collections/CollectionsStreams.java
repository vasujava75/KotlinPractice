...
import practice.collections.Customer;
import practice.collections.Order;
import practice.collections.Product;
...
public class CollectionsStreams {
        ...
        public static Product product1 = new Product(1L, "abc", "Books", 184.83);
        ...
        public static void main(String[] args) {
                System.out.println(products.stream().filter(product -> product.getCategory()!=null).collect(Collectors.groupingBy(Product::getCategory,Collectors.toList())));
        }
